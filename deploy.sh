...
echo "   查看注册机日志:  docker compose logs -f registrar"
echo "   停止所有服务:    docker compose down"
echo ""
echo -e " ${YELLOW}注意:${NC}"
echo "   1. 注册机已作为后台服务运行，请在管理台“自动注册”页面进行控制"
echo "   2. 注册成功的账号会自动推送到管理器账号列表中"
echo "   3. 代理配置请在 config.json 中修改后重启服务: docker compose restart registrar"
echo ""
